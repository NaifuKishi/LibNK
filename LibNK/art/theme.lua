...
if not LibNK.Art then LibNK.Art = {} end

local nkArt   = LibNK.Art

---------- init local variables ---------

local _activeTheme = 'default'
local _themes = { default = { logo              = {'LibNK', 'gfx/nkUILogo.png'},
                ...
                bw              = { logo              = {'LibNK', 'gfx/nkUILogo.png'},
                  ...
                  nkUI = {  logo = {'LibNK', 'gfx/nkUILogo.png'},
...
function nkArt.GetThemeList()       return LibNK.Tools.Table.GetSortedKeys (_themes)  end
