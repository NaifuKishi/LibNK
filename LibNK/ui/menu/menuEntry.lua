...
local function _uiMenuEntry(name, parent) 
	...
	local menuEntry = LibNK.UICreateFrame ('nkFrame', name, parent)	
	local label = LibNK.UICreateFrame ('nkText', name .. '.label', menuEntry)	
	...
	function menuEntry:SetFont(addonInfo, fontName) 
		LibNK.UI.SetFont(label, addonInfo, fontName) 
	end
